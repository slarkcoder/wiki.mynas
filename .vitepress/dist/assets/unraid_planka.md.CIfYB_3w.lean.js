...
const c = JSON.parse(
    '{"title":"适合个人和小团队的看板应用 - Planka","description":"","frontmatter":{},"headers":[],"relativePath":"unraid/planka.md","filePath":"unraid/planka.md","lastUpdated":1725293933000}'
  ),
  l = { name: "unraid/planka.md" };
function e(t, s, h, k, E, r) {
  return (
    p(),
    i(
      "div",
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">      retries</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">5</span></span></code></pre></div><p>修改完成之后，直接点 <code>COMPOSE UP</code> 就可以安装成功。</p><p>Planka 的默认端口是 5000，应用数据都存到了 <code>/user/appdata/planka</code> 下面。</p>`,
            13
          ),
        ])
    )
