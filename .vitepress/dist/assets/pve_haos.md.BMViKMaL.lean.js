...
const m = JSON.parse(
    '{"title":"虚拟 HomeAssistantOS","description":"","frontmatter":{},"headers":[],"relativePath":"pve/haos.md","filePath":"pve/haos.md","lastUpdated":1726936079000}'
  ),
  t = { name: "pve/haos.md" };
function o(c, e, d, l, r, h) {
  return (
    p(),
    s(
      "div",
