...
const h = JSON.parse(
    '{"title":"查找群晖设备","description":"","frontmatter":{},"headers":[],"relativePath":"synology/find_synology.md","filePath":"synology/find_synology.md","lastUpdated":1725293933000}'
  ),
  n = { name: "synology/find_synology.md" };
function l(r, o, i, d, c, p) {
  return (
    s(),
    t(
      "div",
