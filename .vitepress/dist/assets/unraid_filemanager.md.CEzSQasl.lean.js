...
const h = JSON.parse(
    '{"title":"文件管理","description":"","frontmatter":{},"headers":[],"relativePath":"unraid/filemanager.md","filePath":"unraid/filemanager.md","lastUpdated":1725293933000}'
  ),
  i = { name: "unraid/filemanager.md" };
function r(t, a, l, o, c, d) {
  return (
    p(),
    n(
      "div",
...
<span class="line"><span>filebrowser/filebrowser:s6</span></span></code></pre></div><p>默认的用户名和密码均为 admin。</p><p>在 FileBrowser 文件管理器的设置中，可以将语言切换为中文。</p><p><img src="https://img.slarker.me/wiki/jsck66_OSWX7w.png" alt="jsck66_OSWX7w"></p>`,
            23
          ),
        ])
    )
