...
const m = JSON.parse(
    '{"title":"温度监控","description":"","frontmatter":{},"headers":[],"relativePath":"basic/temperature.md","filePath":"basic/temperature.md","lastUpdated":1725293933000}'
  ),
  p = { name: "basic/temperature.md" };
function r(n, a, o, l, h, c) {
  return (
    s(),
    t(
      "div",
