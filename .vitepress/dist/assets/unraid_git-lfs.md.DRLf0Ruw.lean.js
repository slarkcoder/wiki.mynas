import{_ as i,c as a,a2 as n,o as l}from"./chunks/framework.eme8ZeBJ.js";const c=JSON.parse('{"title":"安装 git-lfs","description":"","frontmatter":{},"headers":[],"relativePath":"unraid/git-lfs.md","filePath":"unraid/git-lfs.md","lastUpdated":null}'),t={name:"unraid/git-lfs.md"};function e(p,s,h,d,r,k){return l(),a("div",null,s[0]||(s[0]=[n(`<h1 id="安装-git-lfs" tabindex="-1">安装 git-lfs <a class="header-anchor" href="#安装-git-lfs" aria-label="Permalink to &quot;安装 git-lfs&quot;">​</a></h1><p><code>Git-lfs</code> 是一个 git 的开源扩展，目的是为了解决 git 仓库的大文件托管问题。很多包含大模型的仓库都必须使用 <code>git-lfs</code> 才能把整个 <code>git</code> 仓库拉下来。本篇就介绍如何在 Unraid 上面安装 <code>git-lfs</code>。</p><p><a href="https://github.com/git-lfs/git-lfs/releases" target="_blank" rel="noreferrer">Git-lfs Release</a></p><p>打开 Unraid 终端，依次输入下面的命令：</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 进入到 /home 目录</span></span>
