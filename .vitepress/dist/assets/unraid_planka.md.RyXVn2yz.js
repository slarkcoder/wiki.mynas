...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">      retries</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">5</span></span></code></pre></div><p>修改完成之后，直接点 <code>COMPOSE UP</code> 就可以安装成功。</p><p>Planka 的默认端口是 5000，应用数据都存到了 <code>/user/appdata/planka</code> 下面。</p>`,13),e=[l];function t(h,k,E,r,d,c){return i(),a("div",null,e)}const A=s(p,[["render",t]]);export{o as __pageData,A as default};
